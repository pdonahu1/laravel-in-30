    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img src="https://laracasts.com/images/logo/pixel/triangle-default.png" alt="Your Company" class="size-8" />
          </div>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                ...
                <img src="https://laracasts.com/images/forum/lary-ai-avatar.svg?v=2" alt="Larry Robot" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="https://laracasts.com/images/logo/pixel/triangle-default.png" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
